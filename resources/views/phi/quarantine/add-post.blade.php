        ...
        <div class="col-md-12 " >
            <div class="card">
               <div class="card-header">
                   ...
                   @endif
              <form method="POST" action="{{route('post.addsubmitq')}}" style="padding:50px;">
                  @csrf

                  <div class="form-group">
                      <lable for="nic_no">NIC NO</lable>
                      <input type="" name="nic_no" class="form-control" placeholder="Enter the NIC No "/>
...
@endif
                    ...
                    <div class="form_group">
                      ...
                      <input type="date" name="start_date" class="form-control" placeholder="Enter the start date"/>
...
@endif
                    ...
                    <div class="form_group">
                      ...
                      <input type="date" name="end_date" class="form-control" placeholder="Enter the end date"/>
