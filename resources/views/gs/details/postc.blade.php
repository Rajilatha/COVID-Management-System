				...
				<div class="card">
				  ...
				  <div class="card-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
				 			<label>Message</label>
				 			<textarea name="message" class="form-control" placeholder="Enter Message"> Hi {{$post->fname}} {{$post->lname}}! Thanks for getting the first vaccine. Here attached your first vaccination certificate.  Get your second vaccine  after one month.
