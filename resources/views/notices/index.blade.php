...
<table class="table table-bordered" style="margin:50px;">
    ...
    <tr style="margin:50px;">
        ...
        <td style="margin:50px;"><a class="btn btn-info" href="{{ route('notices.show',$notice->id) }}"><img src="/image/{{ $notice->image }}" width="200px" ></a></td>

        

        <td style="margin:50px;">{{ $notice->detail }}</td>
